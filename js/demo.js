...
app.config(function($routeProvider) {
  $routeProvider.when('http://10.0.0.5/mobile/', {templateUrl: 'http://10.0.0.5/mobile/home.html', reloadOnSearch: false});
...
app.controller('MainController', function($rootScope, $scope) {
  ...
  //
  $scope.chatUsers = [
    {name: 'Jenty Mepa', online: false},
    {name: 'Carline Pienaar', online: true},
